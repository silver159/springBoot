...
// json은 스네이크 표기법을 주로 사용하고 java는 카멜 표기법을 주로 사용하기 때문에 자주 
// 발생되는 문제이다.
// json의 key와 dto 객체의 필드 이름이 다를 경우 @JsonProperty 어노테이션의 인수로 json 데이터의
// key를 지정해서 dto 필드에 지정하면 json 데이터의 key와 dto의 필드 이름이 다르더라도 데이터를
// 받을 수 있다.
